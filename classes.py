...
class Player:
    ...
    def play(self, card_index):
        ...
        2
        """
        this_card = self.hand[card_index]
...
class TACard(Card):
    ...
    def effect(self, opponent_card, player, opponent):
        ...
        300
        """
        new_attack = opponent_card.defense
        new_def = opponent_card.attack
        opponent_card.attack = new_attack
        opponent_card.defense = new_def
...
class ProfessorCard(Card):
    ...
    def effect(self, opponent_card, player, opponent):
        ...
        new_attack = opponent_card.attack
        new_defense = opponent_card.defense
